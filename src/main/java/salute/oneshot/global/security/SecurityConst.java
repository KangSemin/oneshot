...
public class SecurityConst {
    ...
    public static class CSP {
        ...
        public static String buildScriptSrcPolicy(String nonce) {
            return String.format("script-src %s %s %s %s 'nonce-%s';",
                    SCRIPT_SRC_SELF,
                    SCRIPT_SRC_DAUM,
                    SCRIPT_SRC_TOSS,
                    SCRIPT_SRC_CDNJS,
        ...
        public static String buildFrameSrcPolicy() {
            return String.format("frame-src %s %s %s;",
                    FRAME_SRC_SELF,
                    FRAME_SRC_DAUM,
                    FRAME_SRC_TOSS);
        }
        ...
        public static String buildStyleSrcPolicy() {
            return String.format("style-src %s %s %s;",
                    STYLE_SRC_SELF,
        ...
        public static String buildImgSrcPolicy() {
            return String.format("img-src %s;", IMG_SRC_SELF);
        }

        public static String buildFormActionPolicy() {
            return String.format("form-action %s;", FORM_ACTION_SELF);
        }

        public static String buildConnectSrcPolicy() {
            return String.format("connect-src %s %s %s;",
                    CONNECT_SRC_SELF,
                    CONNECT_SRC_TOSS,
                    CONNECT_SRC_WS);
        }

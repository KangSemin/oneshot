...
public class PantryController {
    ...
    public ResponseEntity<ApiResponse<PantryIngrResponseDto>> addIngrToPantry(@PathVariable Long ingredientId,
        @AuthenticationPrincipal CustomUserDetails userDetails) {

        AddPantryIngredientSDto sDto = AddPantryIngredientSDto.of(userDetails.getId(), ingredientId);

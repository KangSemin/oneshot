...
class CocktailControllerTest extends AbstractRestDocsTests {
    ...
    void getCocktailById() throws Exception {
        ...
        given(cocktailService.getCocktail(1L)).willReturn(response);
        given(cocktailService.getCocktail(1L, value)).willReturn(response);
    ...
    void findCocktailsByKeyword() throws Exception {
        ...
        // when & then
        mockMvc.perform(get("/api/cocktails/keyword")
                        .queryParams(
